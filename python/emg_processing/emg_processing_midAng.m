%----------------------------------------------------------\
% Myodata_All_Processing_midAng.m
% Author : Han U. Yoon (2021/01/26)
% Purpose: To give some nice exprience to my commrade J.H. and H.J.
% Revise note: 
%----------------------------------------------------------\

function emg_processing_midAng(instrExercise,innumTrial,strcmap,strAAFTnum)
...
sigDATAnormal = round(sigDATAnormal, 3)
output_path = "./emg_result_midAng/"+ strAAFTnum + "/" + strExercise + "/" + numTrial + ".txt";
