...
def find_Centroid(scatter_data, scatter_target, gausian_num):
    ...
    print("GMM1 mean : ", gmm1.means_, "GMM1 covari : ", gmm1.covariances_)
    print()
    print("GMM2 : ", gmm2.means_, "GMM2 covari : ",  gmm2.covariances_)
    print()
    print("GMM3 : ", gmm3.means_, "GMM3 covari : ",  gmm3.covariances_)
    print()
    print("GMM4 : ", gmm4.means_, "GMM4 covari : ",  gmm4.covariances_)
...
if __name__ == '__main__':
    ...
    for re in range(1):
        ...
        model.fit(x_train, y_train, epochs=1, batch_size=50, validation_data=(x_valid, y_valid), validation_batch_size=50)
